...
// Section: By 2050 goals + four stat cards
</script>
      ...
      >
        ...
        >
          <div class="flex flex-col gap-4 md:gap-8">
            <div
              class="w-full max-w-full md:w-[420px] h-auto flex gap-3 md:gap-6 p-4 bg-white shadow-[0_2px_18px_rgba(0,0,0,0.16)] mx-auto"
            >
              <img
                src="../../assets/card.png"
                alt="card"
